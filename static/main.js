...
var author$project$Image$Image = F6(
...
var author$project$Image$imgDecoder = A2(
...
var author$project$Image$moeDecoder = A2(
...
var author$project$Model$KeyInput = function (a) {
	return {$: 'KeyInput', a: a};
};
...
var author$project$Main$keyHandler = function () {
	var keyDecoder = A2(elm$json$Json$Decode$field, 'key', elm$json$Json$Decode$string);
	var h = function (k) {
		switch (k) {
			case 'Escape':
				return author$project$Model$Unfocus;
			case 'ArrowRight':
				return author$project$Model$KeyInput(author$project$Model$Right);
			case 'ArrowLeft':
				return author$project$Model$KeyInput(author$project$Model$Left);
			default:
				return A2(elm$core$Debug$log, k, author$project$Model$Nop);
		}
	};
	return A2(elm$json$Json$Decode$map, h, keyDecoder);
}();
...
var author$project$Main$subscriptions = function (model) {
	if (model.$ === 'ImList') {
		return elm$browser$Browser$Events$onKeyDown(author$project$Main$keyHandler);
	} else {
...
var author$project$Query$expandTags = function (img) {
	return function (ts) {
		return _Utils_update(
			img,
			{
				tags: _Utils_ap(img.tags, ts)
			});
	}(
...
var author$project$Query$match = F2(
	function (s, img) {
		return A2(
			elm$core$List$any,
			...
			if (_n0.$ === 'Just') {
				var c = _n0.a;
				return A2(elm$core$String$startsWith, s, c);
			} else {
				return false;
			}
		}();
	});
var author$project$Query$query = function (s) {
	return elm$core$List$filter(
		author$project$Query$match(s));
};
var author$project$Utils$isJust = function (m) {
	if (m.$ === 'Just') {
		return true;
	} else {
		return false;
				...
				if (m.$ === 'ImList') {
					...
					return author$project$Model$ImList(
						_Utils_update(
							r,
							{
								focus: A2(elm$core$Maybe$map, g, r.focus)
							}));
				} else {
					return m;
				}
			});
		var isFocus = function (m) {
			if (m.$ === 'ImList') {
				var r = m.a;
				return author$project$Utils$isJust(r.focus);
			} else {
				return false;
			}
		};
...
var author$project$Main$focused = function (fm) {
	var current = A2(
		...
		'/moe/static/404.png',
		A2(elm$core$Array$get, fm.current, fm.data));
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$href(current)
							]),
						_List_fromArray(
							[
								A2(
...
var author$project$Main$sideList = function (fm) {
	var focusOn = function (i) {
		return author$project$Model$Focus(
			_Utils_update(
				fm,
				{current: i}));
	};
				...
				_List_fromArray(
					[
						...
						A2(
							...
							elm$core$Basics$append('gi')),
						elm$core$String$fromInt)(i),
						elm$html$Html$Attributes$class('if-wps-img'),
						_Utils_eq(i, fm.current) ? elm$html$Html$Attributes$class('if-wps-head') : A2(elm$html$Html$Attributes$style, '', ''),
	...
	return elm$core$Array$toList(
		A2(elm$core$Array$indexedMap, viewThumb, fm.data));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$Attributes$class('img-item')
			]),
		_List_fromArray(
			[
				A2(
...
var author$project$Main$viewInfo = function (image) {
	...
	var fmod = {
		current: elm$core$List$isEmpty(image.wp) ? 0 : 1,
		data: elm$core$Array$fromList(
			A2(
				elm$core$List$cons,
				author$project$Image$imgpath(image),
				A2(elm$core$List$map, author$project$Image$wppath, image.wp)))
	};
	return A2(
		elm$html$Html$span,
		_List_Nil,
...
var author$project$Main$viewImage = function (image) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'display', cssDisplay)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('img-item-box')
					]),
				_List_fromArray(
					[
...
var author$project$Main$viewImages = F2(
	function (_n0, is) {
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class(cname + '-box bloc-img-cat'),
					elm$html$Html$Attributes$id(cname)
				]),
			_List_fromArray(
				[
					A2(
...
var author$project$Main$imgRoot = function (ls) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('bloc-img')
			]),
		_List_fromArray(
			[
				A2(
...
var author$project$Main$txtbox = function (msg) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('bloc-query')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('query-wrapper')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$placeholder('filter: book, tan, lyah, hpffp, karen, etc.'),
...
var author$project$Main$view = function (model) {
	switch (model.$) {
		case 'Failure':
			...
			return A2(
				elm$core$Debug$log,
				'getMoe: ' + elm$core$Debug$toString(e),
				A2(
					elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text('something happened :^)')
						])));
		case 'Start':
